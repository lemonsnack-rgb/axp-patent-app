  ...
  return (
    ...
    >
      <nav className="p-2 flex flex-col gap-0.5">
        <NavItem icon="edit"    label="새 명세서"  active={isActive('newtask')} collapsed={sidebarCollapsed} onClick={() => setMode('newtask')} primary />
  ...
  return (
    ...
    >
      ...
      <span className="flex-1 min-w-0">
        ...
        <div className="text-xs2 text-zinc-400 mt-0.5 flex items-center gap-1 min-w-0" title={t.techField ? `${t.techField} · ${ago}` : ago}>
