// 평면 SVG 아이콘 세트 (mockup과 동일)
import type { ReactElement, SVGProps } from 'react';

type IconName =
  | 'doc' | 'search' | 'paper' | 'folder' | 'library' | 'edit'
  | 'plus' | 'close' | 'check' | 'star' | 'star-filled'
  | 'hamburger' | 'help' | 'bell' | 'settings'
  | 'cal' | 'user' | 'tag' | 'target' | 'image' | 'book'
  | 'grid' | 'link' | 'scale' | 'award' | 'globe' | 'briefcase'
  | 'chevron-down' | 'chevron-left' | 'chevron-right' | 'arrow-left'
  | 'clipboard' | 'logo';
...
const paths: Record<IconName, ReactElement> = {
  ...
  paper:     <><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="8" y1="12" x2="16" y2="12"/><line x1="8" y1="16" x2="16" y2="16"/></>,
  ...
  scale:     <><path d="M16 11V3"/><path d="M3 7h18"/><path d="M16 17v4"/><path d="M8 3v4"/><circle cx="12" cy="12" r="9"/></>,
