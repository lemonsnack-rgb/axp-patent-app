...
export const SPEC_CATALOG: Record<string, SpecEntry> = {
  ...
  'PAT-INP-040': {
    id: 'PAT-INP-040',
    screen: '특허 · 검색어 입력',
    component: '검색식 입력창 + 검색/초기화',
    display: '입력창 + 우측 검색·초기화 버튼',
    interaction: '검색 실행 / 초기화',
    precondition: '검색식 입력창 또는 항목별 필드에 값 1개 이상',
    postcondition: '검색=searchQuery 조립·POST → 결과 목록 전환·히스토리 1건 추가·(연동 시)URL 직렬화 / 초기화=입력값·활성필드 디폴트 복원',
  },
  'PAT-INP-050': {
    id: 'PAT-INP-050',
    screen: '특허 · 검색어 입력',
