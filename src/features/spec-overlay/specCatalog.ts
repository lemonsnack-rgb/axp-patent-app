...
export const SPEC_CATALOG: Record<string, SpecEntry> = {
  ...
  'SPC-EDT-032': { id: 'SPC-EDT-032', screen: '명세서 · 대화형 수정', component: '반영 / 무시', display: '반영·무시 버튼 / 반영됨·무시됨 상태', interaction: '클릭', precondition: '제안 status=pending', postcondition: '반영=해당 블록에 적용(accepted) · 무시=declined · 미선택=pending' },
  ...
  'SPC-AST-032': { id: 'SPC-AST-032', screen: '명세서 · AI 어시스턴트(작성 플로우)', component: '반영 / 무시', display: '반영·무시·다시생성 / 반영됨·무시됨', interaction: '클릭', precondition: '제안 status=pending', postcondition: '반영=섹션에 적용 · 무시=declined · 다시생성' },
