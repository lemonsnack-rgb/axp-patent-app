...
export const SPEC_CATALOG: Record<string, SpecEntry> = {
  ...
  'SPC-EDT-032': { id: 'SPC-EDT-032', screen: '명세서 · 대화형 수정', component: '적용 / 거절', display: '적용·거절 버튼 / 적용됨·거절됨 상태', interaction: '클릭', precondition: '제안 status=pending', postcondition: '적용=해당 블록에 반영(accepted) · 거절=declined · 미선택=pending' },
  ...
  'SPC-EDT-040': { id: 'SPC-EDT-040', screen: '명세서 · 대화형 수정', component: '플랜 진행', display: 'N/M 단계 · 스텝 목록 · 진행/중단', interaction: '진행(다음 스텝)/중단', precondition: 'intent=plan(다단계 지시) · 청구항 수정(독립→종속)', postcondition: '스텝별 수정 제안 생성 · 진행 중 입력 잠금 · 중단 시 정지' },
  ...
  'SPC-AST-032': { id: 'SPC-AST-032', screen: '명세서 · AI 어시스턴트(작성 플로우)', component: '적용 / 거절', display: '적용·거절·다시생성 / 적용됨·거절됨', interaction: '클릭', precondition: '제안 status=pending', postcondition: '적용=섹션에 반영 · 거절=declined · 다시생성' },
