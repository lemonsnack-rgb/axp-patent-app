...
export const SPEC_CATALOG: Record<string, SpecEntry> = {
  ...
  'PAT-LST-030': { id: 'PAT-LST-030', screen: '특허 · 결과 목록', component: '패싯 필터바/사이드바', display: '국가 · 권리상태 · 출원연도 · 출원인 대표명화(상위5) · IPC(상위5) · 심판 유무', interaction: '체크 후 실행', precondition: '결과 1건 이상 · 패싯 로드됨', postcondition: '체크한 축을 필터에 추가해 재검색 → 1페이지로 이동' },
