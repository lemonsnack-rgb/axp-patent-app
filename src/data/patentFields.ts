...
export const PATENT_FIELDS_BASE: PatentField[] = [
  ...
  { code: 'DSC',       label: '상세설명',          ph: '딥러닝 and 포인트 클라우드',           group: '텍스트' },
  { code: 'AP',        label: '출원인',            ph: '현대자동차',                   group: '인명' },
  { code: 'IPC_ALL',   label: 'IPC(All)',          ph: 'G01S 17/93',                   group: '분류', type: 'ipc' },
...
export const PATENT_FIELDS_EXT: PatentField[] = [
  ...
  { code: 'INV',       label: '발명자',                     ph: '김OO',                            group: '인명정보' },
